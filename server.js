...
setInterval(() => {
  http.get(`http://xyphers.glitch.me/`);
}, 280000);
...
const youtube = new YouTube("AAIzaSyCd-PLoJkmZHfv4LGrJ7sCtGSDmUms_Jg8"); //تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@456126178848145429>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
